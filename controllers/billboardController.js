...
module.exports = (io) => {
  ...
  exports.createBillboard = async (req, res) => {
    try {
      ...
      if (io) {
        io.emit('assets-updated', { type: 'billboard', action: 'create', id: result[0].id });
        console.log('[SOCKET] Emitted assets-updated for new billboard');
      }
  ...
  exports.updateBillboard = async (req, res) => {
    try {
      ...
      // Notify all players that assets have been updated
      if (io) {
        io.emit('assets-updated', { type: 'billboard', action: 'update', id });
        console.log('[SOCKET] Emitted assets-updated for billboard update');
      }
  ...
  exports.approveBillboard = async (req, res) => {
    try {
      ...
      // Notify all players that assets have been updated
      if (io) {
        io.emit('assets-updated', { type: 'billboard', action: 'approve', id });
        console.log('[SOCKET] Emitted assets-updated for billboard approval');
      }
  ...
  exports.rejectBillboard = async (req, res) => {
    try {
      ...
      // Notify all players that assets have been updated
      if (io) {
        io.emit('assets-updated', { type: 'billboard', action: 'reject', id });
        console.log('[SOCKET] Emitted assets-updated for billboard rejection');
      }
  ...
  exports.deleteBillboard = async (req, res) => {
    try {
      ...
      // Notify all players
      if (io) {
        io.emit('assets-updated', { type: 'billboard', action: 'delete', id });
        console.log('[SOCKET] Emitted assets-updated for billboard deletion');
      }
